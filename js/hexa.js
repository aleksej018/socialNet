    ...
    async function createPost() {
        ...
        document.querySelector('#allPostsWrapper').innerHTML = `<div class="single-post" data-post_id="${post.id}">
                                                                    ...
                                                                    <div class="post-actions">
                                                                        ...
                                                                        <div>
                                                                            <button onclick="likePost(this)" class="likePostJS like-btn"><span>${post.likes} Likes</span></button>
                                                                    ...
                                                                    <div class="post-commments">
                                                                        <form>
                                                                            <input placeholder="Napisite komentar..." type="text">
    ...
    all_posts.forEach(post => {
        async function getPostUser() {
            ...
            <div class="post-actions">
                ...
                <div>
                    <button onclick="likePost(this)" class="likePostJS like-btn"><span>${post.likes}</span> Like</button>
                        <button class="comment-btn" onclick="commentPost(this)">Comments</button>
                    ${delete_post_html}
                </div>
            </div>
